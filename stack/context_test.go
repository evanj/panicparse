				...
				Stack: Stack{
					Calls: []Call{
						...
						newCall(
							...
							Args{Values: []Arg{{Value: 0xc208033b20, IsPtr: true}}},
							"/gopath/src/gopkg.in/yaml.v2/yaml.go",
							153),
						newCall(
							"reflect.Value.assignTo",
							Args{Values: []Arg{{Value: 0x570860}, {Value: 0xc20803f3e0, IsPtr: true}, {Value: 0x15}}},
			...
			Signature: Signature{
				...
				Stack: Stack{
					Calls: []Call{
						newCall(
							"gopkg.in/yaml%2ev2.handleErr",
							Args{Values: []Arg{{Value: 0xc208033b21, Name: "#1", IsPtr: true}}},
							"/gopath/src/gopkg.in/yaml.v2/yaml.go",
							153),
					},
				},
			...
			Signature: Signature{
				...
				Stack: Stack{
					Calls: []Call{
						newCall(
							"gopkg.in/yaml%2ev2.handleErr",
							Args{Values: []Arg{{Value: 0xc208033b22, Name: "#2", IsPtr: true}}},
							"/gopath/src/gopkg.in/yaml.v2/yaml.go",
							153),
					},
				},
				...
				Stack: Stack{
					Calls: []Call{
						...
						newCall(
							...
							Args{Values: []Arg{{Value: 0xc000338200, Name: "#1", IsPtr: true}}},
							"/home/maruel/go/src/foo/bar_test.go",
							155),
						newCall(
							"testing.tRunner",
							Args{Values: []Arg{{Value: 0xc000338200, Name: "#1", IsPtr: true}, {Value: 0x1615bf8, IsPtr: true}}},
							"/home/maruel/golang/go/src/testing/testing.go",
							865),
					},
				},
